# check_Coro27_25.sage -- Corollary 27.25 (rank-one perturbation, s=2) of d51coro.tex.
# f_s = (sin x + 1)/cos^2 x + s sin x;  HH_n(f_s) = (1 - s C(n,2)) prod_{k<n}(k!)^2 (2k+1)!!.
# Run:  sage check_Coro27_25.sage N
import sys
...
def base(n): return (1-n*(n-1))*HE(n)
_run("Corollary 27.25 (rank-one, s=2): f_s=(sin x+1)/cos^2 x + s sin x",
