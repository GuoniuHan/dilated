# check_Coro27_22.sage -- Corollary 27.22 (rank-one perturbation, s=-1) of d51coro.tex.
# f_s = (sin x + 1)/cos^2 x + s sin x;  HH_n(f_s) = (1 - s C(n,2)) prod_{k<n}(k!)^2 (2k+1)!!.
# Run:  sage check_Coro27_22.sage N
import sys
...
def base(n): return (binomial(n,2)+1)*HE(n)
_run("Corollary 27.22 (rank-one, s=-1): f_s=(sin x+1)/cos^2 x + s sin x",
