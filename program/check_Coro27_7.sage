# check_Coro27_7.sage -- Corollary 27.7 (cor:g1) of d51coro.tex: Gaussian c=1 (involutions).
# f=e^{x+x^2/2}, a_n = involution numbers = sum_j binom(n,2j)(2j-1)!!.
#   HH_n     = 2^C(n,2) prod_{k<n} k!
#   HH_n(f') = det(a_{2i+j+1}) = HH_n   (invariant under differentiation)
# Run:  sage check_Coro27_7.sage N
import sys
...
_run("Corollary 27.7 (cor:g1): Gaussian c=1 (involution numbers)",
     [("HH_n", lambda n: HH(n), RHS), ("HH_n(f')", lambda n: HH(n,1), RHS)])
