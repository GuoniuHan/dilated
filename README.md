...
| Lemma 10.8 (rank of $`N`$) | $`\mathrm{rank}N\rvert_{s=-(2k+1)}\le k+1`$; $`(s+2k+1)^{\underline n-1-k}\mid\det N`$ | [`check_Lem10_8.sage`](program/check_Lem10_8.sage) | [`.txt`](output/check_Lem10_8.txt) |
